...
export default function AboutClient() {
    const milestones = [
        ...
        { year: "2021", title: "Expansion", desc: "Integrated invisible grill technology and expanded service centers across Tamil Nadu, including Pondicherry and Trichy." },
            ...
            <div className="container-large relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center mb-32">
                    <div className="lg:col-span-6">
                        ...
                        >
                            For over a decade, John Enterprises has redefined protection across Tamil Nadu. We combine structural engineering principles with premium materials to secure your spaces with clinical precision.
                        </motion.p>
                    ...
                    >
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center">
                            ...
                            <p className="text-slate-500 font-medium max-w-xs uppercase tracking-widest text-[10px]">Premium Standards 2024</p>
                        </div>
                    </motion.div>
                </div>
